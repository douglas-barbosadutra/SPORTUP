package it.contrader.gateway.repository;

import it.contrader.gateway.GatewayApp;
import it.contrader.gateway.config.Constants;
import it.contrader.gateway.config.audit.AuditEventConverter;
import it.contrader.gateway.domain.PersistentAuditEvent;
...
import static it.contrader.gateway.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
