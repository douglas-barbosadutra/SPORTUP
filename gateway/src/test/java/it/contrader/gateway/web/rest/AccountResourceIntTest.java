package it.contrader.gateway.web.rest;

import it.contrader.gateway.config.Constants;
import it.contrader.gateway.GatewayApp;
import it.contrader.gateway.domain.Authority;
import it.contrader.gateway.domain.User;
import it.contrader.gateway.repository.AuthorityRepository;
import it.contrader.gateway.repository.UserRepository;
import it.contrader.gateway.security.AuthoritiesConstants;
import it.contrader.gateway.service.MailService;
import it.contrader.gateway.service.dto.UserDTO;
import it.contrader.gateway.service.dto.PasswordChangeDTO;
import it.contrader.gateway.web.rest.errors.ExceptionTranslator;
import it.contrader.gateway.web.rest.vm.KeyAndPasswordVM;
import it.contrader.gateway.web.rest.vm.ManagedUserVM;
import it.contrader.gateway.service.UserService;
