...
import { TrainingCardComponent } from 'app/entities/fitmicroservice/training-card/training-card.component';
...
describe('Component Tests', () => {
    describe('TrainingCard Management Component', () => {
        let comp: TrainingCardComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(TrainingCardComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.trainingCards[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
