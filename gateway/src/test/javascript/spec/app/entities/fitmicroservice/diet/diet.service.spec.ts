    ...
    describe('Diet Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'fitmicroservice/api/diets';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Diet', () => {
                service.create(new Diet(null)).subscribe(received => {
            ...
            it('should update a Diet', () => {
                service.update(new Diet(123)).subscribe(received => {
