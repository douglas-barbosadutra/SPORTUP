...
<body>
	...
	<form action="TeamServlet?richiesta=updateTeam" method="post">
			<h3>
				ID: <input type="text" id="team" name="id_team"
					placeholder="inserisci id del team">
				INFO: <input type="text" id="team" name="info"
					placeholder="inserisci nuova info">
			</h3>
